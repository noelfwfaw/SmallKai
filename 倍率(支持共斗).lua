...
function HS9()
	...
	gg.setRanges(32)
	-- 第一次搜索
	gg.searchNumber("0.0001;1;0;35::30", gg.TYPE_AUTO , false, gg.SIGN_EQUAL, 0, -1, 0)
	...
	if results==nil then
		...
		gg.setRanges(32)
		-- 第二次搜索
		gg.searchNumber("0.0001E;1D;0F;35D::30", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
...
function HS666()
	...
	if results==nil then
		...
		gg.setRanges(32)
		-- 第二次搜索
		gg.searchNumber("0.0001E;"..n..";0F;35D::30", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
